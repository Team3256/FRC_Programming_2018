...
public class Rotation {
    ...
    /**
     * Converts this rotation matrix to a translation vector
     * Basically, we are creating the unit vector with the angle of this rotation matrix from the positive x-axis
     * @return Translation vector generated by this Rotation matrix
     */
    public Translation toTranslation(){
        return new Translation(this.cos, this.sin);
    }

    /**
     * Checks if this rotation is parallel with another specified rotation
     *
     * Basically converts the rotation matrices to translation vectors and finds the cross product between them.
     * If the cross product is around 0, then they are parallel
     *
     * @param other Rotation to compare
     * @return true if the rotations are parallel
     */
    public boolean isParallel(Rotation other){
        return Math.abs(this.toTranslation().cross(other.toTranslation())) < kEpsilon;
    }
