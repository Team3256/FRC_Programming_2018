...
public class Constants {
    ...
    public static final int kPortOne = 1;
    public static final int kPortTwo = 2;
    public static final int kPortThree = 3;
    public static final int kPortFour = 4;
    public static final int kPortFive = 5;
