...
public class RightScaleTwoCubeAuto extends AutoModeBase {
    ...
    protected void routine() throws AutoModeEndedException {
        ...
        if(scaleSide == GameDataAccessor.Side.RIGHT && switchSide == GameDataAccessor.Side.RIGHT){
            ...
            currVel = DriveTrain.getInstance().getAverageVelocity();
            DriveTrain.getInstance().resetGyro();
            runAction(new FollowTrajectoryAction(currVel, 0.0, 10.0, 0));
            ...
            runAction(new FollowArcTrajectoryAction(0.0,0.0,58,-58,false));
            //runAction(new FollowTrajectoryAction(0.0,0.0,44,-48));
            DriveTrain.getInstance().resetGyro();
            runAction(new FollowTrajectoryAction(0.0,0.0,-7.0,0));
